...
class DayViewScrollPanel extends React.Component {
  ...
  renderItem(index, key) {
    ...
    squareDate.add(index - 5000, 'days');
    ...
    return <div id={squareDate.format("YYYY-MM-DD")} key={key} className={'dayItem ' + (index % 2 ? '' : ' even')} >
      <DaySquare black={color} date={squareDate} view="day" dropHandler={this.props.dropHandler} items={itemsForDate}/>
    </div>;
  }
